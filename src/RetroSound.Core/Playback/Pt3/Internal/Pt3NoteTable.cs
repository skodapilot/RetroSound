...
internal static class Pt3NoteTable
{
    private static readonly int[] ProTracker33To34 =
    [
    ...
    private static readonly int[] ProTracker34To35 =
    [
    ...
    private static readonly int[] SoundTracker =
    [
    ...
    private static readonly int[] Asm34 =
    [
    ...
    private static readonly int[] Asm34To35 =
    [
    ...
    private static readonly int[] Real34 =
    [
    ...
    private static readonly int[] Real34To35 =
    [
        0xCDA, 0xC22, 0xB73, 0xACF, 0xA33, 0x9A1, 0x917, 0x894, 0x819, 0x7A4, 0x737, 0x6CF,
        0x66D, 0x611, 0x5BA, 0x567, 0x51A, 0x4D0, 0x48B, 0x44A, 0x40C, 0x3D2, 0x39B, 0x367,
        0x337, 0x308, 0x2DD, 0x2B4, 0x28D, 0x268, 0x246, 0x225, 0x206, 0x1E9, 0x1CE, 0x1B4,
    ...
    public static int GetTonePeriod(int noteIndex, Pt3FrequencyTableKind frequencyTable, int version)
    {
        if (noteIndex is < 0 or >= 96)
        {
            throw new ArgumentOutOfRangeException(nameof(noteIndex), "PT3 note index must be in range 0..95.");
        }

        var table = frequencyTable switch
        {
            Pt3FrequencyTableKind.ProTracker => version <= 3 ? ProTracker33To34 : ProTracker34To35,
            Pt3FrequencyTableKind.SoundTracker => SoundTracker,
            Pt3FrequencyTableKind.AsmOrPsc => version <= 3 ? Asm34 : Asm34To35,
            Pt3FrequencyTableKind.RealSound => version <= 3 ? Real34 : Real34To35,
            _ => throw new ArgumentOutOfRangeException(nameof(frequencyTable)),
        };
